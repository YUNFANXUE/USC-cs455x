...
public class MineField {
   ...
   private int numMinesInArray;
   private int mineFieldArrayRows;
   private int mineFieldArrayColums;
   private boolean mineFieldArray[][];
   ...
   */    
   ...
   private void mineGenerator() {
      int numGenerate = 0;
      int randomBound = (mineFieldArrayRows - 1) * (mineFieldArrayColums - 1);
